...
<b>This is a slightly customized version of the theme that uses a portfolio page. Custom code is in the layouts _default filer `portfolio.htlml` and in the extended css with the same name.</b>
